      ...
      <div className="p-6">
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="mx-1">
              <Card type="warehouses" total={totalWarehouses} onClick={onWarehouses}/>
            </div>
            <div className="mx-1">
              <Card type="retailers" total={totalRetailers} onClick={onRetailers}/>
            </div>
          </div>
