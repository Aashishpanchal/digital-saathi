        ...
        <Form>
          <div className="w-full md:w-[28rem] lg:w-[28rem]">
            ...
            <div className="my-4">
              ...
              <TextInput id="customer-name" type={"text"} name="customer_name" value={data.customer_name} onChange={onChange}/>
            </div>
            <div className="my-4 flex items-center gap-2">
              <Checkbox name="active" checked={Boolean(data.active)} onChange={(e) => {
