...
export default function ProductWeightPrice() {
    ...
    const onUpdate = async (setInnerLoading) => {
    ...
    const onProductWeightPriceDelete = async () => {
        if (value) {
            ...
            try {
                setInnerLoading(true);
                const res = await shopProductWeightPrice("delete", {
                    params: price_id,
                });
                if (res.status === 200) {
    ...
    const columns = React.useMemo(() => [
        ...
        },
        {
            Header: "Focus SKU",
            accessor: "focus_sku",
            Cell: (cell) => (<FocusSKUCell cell={cell} idKey="price_id" setData={setData} onUpdate={onUpdate}/>),
        },
        {
            Header: "Action",
    ...
    return (<AdminContainer>
      ...
      <DeleteModal show={deleteModalShow} onClose={() => setDeleteModalShow(false)} onClickNo={() => setDeleteModalShow(false)} onClickYes={onProductWeightPriceDelete}/>
    </AdminContainer>);
}
