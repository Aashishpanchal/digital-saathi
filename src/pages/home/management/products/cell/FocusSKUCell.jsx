...
export default function FocusSKUCell(props) {
    ...
    return (<div className="flex justify-center items-center">
      <div onClick={onUpdate} className={"hover:cursor-pointer w-fit border-2 px-1 py-1 rounded-lg bg-white shadow-sm ".concat(focusSku === 1 ? "border-yellow-300 text-yellow-300" : "")}>
